  ...
  return Expanded(
    child: GridView.count(
      ...
      children: <Widget>[
        InkWell(
          onTap: (){
            Navigator.pushNamed(context, '/FurniturePage', arguments: "Tables");
          },
          child: Container(
            color: Colors.red,
            child: Padding(
        ...
        InkWell(
          onTap: (){
            Navigator.pushNamed(context, '/FurniturePage', arguments: "Sofas");
          },
          child: Container(
              color: Colors.red,
              padding: const EdgeInsets.all(10.0),
        ...
        InkWell(
          onTap: (){
            Navigator.pushNamed(context, '/FurniturePage', arguments: "Chairs");
          },
          child: Container(
            color: Colors.red,
            padding: const EdgeInsets.all(10.0),
            child: Column(
              ...
              children: <Widget>[
                Text("Chairs", style: TextStyle(fontSize: 30, color: Colors.white),),
                Row(
        ...
        InkWell(
          onTap: (){
            Navigator.pushNamed(context, '/FurniturePage', arguments: "Cupboards");
          },
          child: Container(
            color: Colors.red,
            padding: const EdgeInsets.all(10.0),
              ...
              children: <Widget>[
                ...
                Row(
                  ...
                  children: <Widget>[
                    Padding(
                      padding: const EdgeInsets.only(top: 10),
                      child: Text("Cupboards",style: TextStyle(
